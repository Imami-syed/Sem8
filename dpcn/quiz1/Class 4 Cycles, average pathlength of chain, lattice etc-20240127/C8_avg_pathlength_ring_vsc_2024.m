...
%%
figure;
plot(ZZ(:,2),ZZ(:,3),'-','LineWidth',3);
hold on;
scatter(ZZ(:,2),ZZ(:,4),'o','filled','LineWidth',10)
hold on;
% scatter(ZZ(:,2),ZZ(:,5),'s','filled','LineWidth',10)
% hold on;
set(gcf,'InvertHardCopy','off','Color','white');
xlabel('neighbours','Interpreter','LaTeX','FontSize',30);
...
%figure;
figure ;
plot(ZZ(:,2),ZZ(:,6),'-','LineWidth',3);
hold on;
scatter(ZZ(:,2),ZZ(:,7),'o','filled','LineWidth',10)
hold on;
